export const mbbsingermany = {
    ...
    "info": [
        ...
        },
        {
            ...
            "row": [
                ...
                ["Recognition of Universities", "NMC & WHO accredited"],
        ...
        },
        {
            ...
            "img": "",
            "data": "<p>After all the process done, you will have to submit all the required document to apply in German embassy.</p>"
        },
        {
            "type": "list-bollet",
            "title": "",
            "info": "Below are the list of documents required to study MBBS course in Germany:",
            "data": [
    ...
    "qna":
        [],
    meta: [{ name: "title", content: "MBBS in Germany 2023 - Free MBBS Admission for Indian Students" },{ name: "description", content: "Looking to apply for MBBS in Germany? Get low fees structure with best medical universities in Germany which is recognized by NMC. Call us for more details." },],link:[{ rel:"canonical", href:"https://www.selectyouruniversity.com/course/mbbs-in-germany"},]
}
