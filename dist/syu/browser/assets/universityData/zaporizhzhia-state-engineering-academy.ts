export const zaporizhzhiastateengineeringacademy= {
    "Title": "ZAPORIZHZHIA STATE ENGINEERING ACADEMY",
    ...
    meta: [{ name: "title", content: "Zaporizhzhia State Engineering Academy, Ukraine" },{ name: "description", content: "Zaporizhzhia State Engineering Academy offers Engineering in Ukraine at just approximately $1000 per year. The university offers Engineering of 4 years duration." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/zaporizhzhia-state-engineering-academy"}]
}