export const universityforthecreativearts = {
    ...
    meta: [{ name: "title", content: "University for the Creative Arts, UK" },{ name: "description", content: "The University for the Creative Arts is England's well-known university for Arts, Design, and Media courses. Founded in 2005, it offers these courses to study In UK" },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/university-for-the-creative-arts"}]
}
