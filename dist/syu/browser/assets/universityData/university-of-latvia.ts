export const universityoflatvia= {
    ...
    "url":"university-of-latvia",
...

        {
            ...
            "row": [
                     ["Intake for Course","January"],
                     ["Programs offered","Bachelor, Master, Engineering, BBA"],
                     ["Entrance Examination","Yes"],
                     ["Annual Tuition Fees (approx)","2.1 Lakh onwards"],
                     ["Duration of Course","2-4 years"],
                     ["Students Enrollment","16,000+"],
                     ["Medium of Teaching","English"],
                     ["University Ranking","Country - 1<br>World - 1072"],
                     ["Recognition","Min of Education and Science of Latvia"]
                    ]
        },
          {
            type: 'list-bollet',
    ...
    },
    {
        ...
        data: "<p>The leading University of Latvia is officially accredited with the Min of Higher education and Science of the Republic of the Latvian state.</p>"
    },
    {
        type: 'list-bollet',
        title: '',
    ...
    meta: [{ name: "title", content: "University of Latvia, Latvia" },{ name: "description", content: "Established in 1919, the University of Latvia is ranked as no. 1 in country. With 16,000 students enrolled per year it is the best choice for Engineering in Latvia." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/university-of-latvia"}]
}
