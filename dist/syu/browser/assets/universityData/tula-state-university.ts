export const tulastateuniversity = {
    ...
    "info": [
        ...
        },
        {
            ...
            "row": [
                ...
                ["Eligibility Criteria", "Any passing grades or marks in PCB"],
                ["NEET Exam", "Yes, it is compulsory"],
                ["Annual Tuition Fees", "3300 USD (approx)"],
                ["Medium of Education", "English"],
                ["Course Duration", "6 years with internship"],
                ["University Ranking", "Country - 249 World - 6636"],
        ...
        },
        {
            ...
            "row": [
                {
                    "Name of University": "Tula State University",
                    "Appeared": "1",
                    "Total Pass": "1",
                    "Pass %": "100.00%"
    ...
    "coursesandfees": [
        ...
        },
        {
            ...
            "info": "",
            "data": '<p><strong>Russia’s Tula State University has only 2 faculties:</strong></p>'
        },
        {
            "type": "text",
            "title": "",
    ...
    "addmission": [
        ...
        },
        {
            ...
            "info": "",
            "data": "<p><b>Following is the admission procedure for applying to MBBS course at Tula State University:</b></p><p><b style=color:red><u>Step 1</u>:</b> Applicants should fill the application form available online. They can send the documents via email.</p><p><b style=color:red><u>Step 2</u>:</b> Then they have to submit a school leaving certificate, a birth certificate, a copy of passport, and transcripts of records and other necessary documents.</p><p><b style=color:red><u>Step 3</u>:</b> Students will receive an admission letter from the university, once they submit the above documents.</p><p><b style=color:red><u>Step 4</u>:</b> The Registration Fees should be paid to the University Account or through net banking.</p><p><b style=color:red><u>Step 5</u>:</b> For study on the confirmation of the admission by respective universities, the Department of Federal Migration Service of the Russian Federation will start issuing the official invitation letter to the students.</p><p><b style=color:red><u>Step 6</u>:</b> On receiving an admission letter from Russian Federation, students would need to visit the embassy/ consulate of the Russian Federation in your country for a student visa.</p>"
        },
        {
            "type": "list-bollet",
    ...
    meta: [{ name: "title", content: "Tula State University, Russia" },{ name: "description", content: "Tula state Medical University offers Russia's most affordable MBBS course and quality education. The university has been providing the MBBS in Russia since 1930." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/tula-state-university"}]
}
