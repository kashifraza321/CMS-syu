export const tianjinmedicaluniversity= {
    ...
    "url":"tianjin-medical-university",
...

        {
            ...
            "row": [
                     ...
                     ["Annual Tuition Fees (Approx.)","Rs.5.08 Lakhs/Year"],
                     ["Course Duration","6 years (with internship)"],
                     ["Medium of Education","English"],
                     ["University Ranking","Country - 339<br>World - 2733"],
...

  {
    ...
    "News & Articles": {},
    "Hostel": {},
  meta: [{ name: "title", content: "Tianjin Medical University" },{ name: "description", content: "Founded in 1951, Tianjin Medical University offers MBBS in China in English medium. It is an NMC approved medical university of China. Apply now." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/tianjin-medical-university"}]
}
