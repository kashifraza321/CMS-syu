export const kyivschoolofeconomics = {
    ...
    "qna":
        [],
        meta: [{ name: "title", content: "Kyiv School of Economics, Ukraine" },{ name: "description", content: "Kyiv School of Economics (KSE) is the top management institute of Ukraine offering a high standard of MBA education to worldwide students." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/kyiv-school-of-economics"}]
}