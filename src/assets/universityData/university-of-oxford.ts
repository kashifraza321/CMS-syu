export const universityofoxford= {
    ...
    meta: [{ name: "title", content: "University of Oxford, England" },{ name: "description", content: "The University of Oxford is the number one university for MBA in the UK. It offers the best MBA education in the UK." },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/university-of-oxford"}]
}
