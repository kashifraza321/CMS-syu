export const tarasshevchenkonationaluniversityofkyiv= {
    ...
    "url":"taras-shevchenko-national-university-of-kyiv",
...

        {
            ...
            "row": [
                     ...
                     ["Total Students","23686 (Students Enrolled)"],
                     ["Duration of MBBS Course","6 years including internship"],
                     ["Medium of Education","English & European"],
                     ["University Recognition","Received 4th level accreditation"],
                     ["University Ranking","Country Rank - 2<br>World Rank - 1414"]
                    ]
        },
          {
            type: 'list-bollet',
  ...
  meta: [{ name: "title", content: "Taras Shevchenko National University of Kyiv - Fees & Ranking" },{ name: "description", content: "Find out the cost of living, accommodation facilities, eligibility, admission process, for studying MBBS in Ukraine at Taras Shevchenko National University of Kyiv" },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/taras-shevchenko-national-university-of-kyiv"}]
}
