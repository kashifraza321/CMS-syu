export const cardiffmetropolitanuniversity= {
    ...
    "url":"cardiff-metropolitan-university",
        ...
        {
            "type": "table-title",
            "title": "Cardiff Metropolitan University - Quick Highlights 2022",
        ...
        },
        {
            ...
            title: '',
            info: '',
            data: '<p><b style="color: red;"><u>Note:</u></b> Research degrees i.e. MPhil, PhD, Professional Doctorate and Taught Doctorate requires IELTS scores of 6.5 with 6.5 in reading and writing or the equivalent in a UKVI recognised English Language test.</p>',
        },
        {
            "type": "table",
            "title": "Cardiff Metropolitan University - Ranking 2022",
    ...
    meta: [{ name: "title", content: "Cardiff Metropolitan University, UK" },{ name: "description", content: "Founded in 1996 in Wales, Cardiff Metropolitan University is a great option to study in UK. It has a history back to 1865 with 2 campuses and around 11000 students" },],link: [{ rel: "canonical", href: "https://www.selectyouruniversity.com/university/cardiff-metropolitan-university"}]
}
