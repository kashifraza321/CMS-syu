export const mbainireland= {
    ...
    "url":"mba-in-ireland",
...

        {
            ...
            "row": [
                     ...
                     ["Eligibility Criteria","A graduate from any discipline like Science, Commerce, Arts, Engineering, BCA with 3 to 5 years of work experience. (for a postgraduate course in management)"],
                     ["IELTS or TOEFL","Yes, required."],
                     ["Duration","1 or 2 years (for a postgraduate course in management, that is MBA)"],
                     ["Examination Type",	"Semester pattern"],
                     ["Course Fees","Rs.7 Lakhs to Rs.12 Lakhs per year"],
                     ["Admission Process","Depending on the entrance exam"],
                     ["Course Type","Full time/Distance learning mode"],
                     ["Top Recruiting Companies","Amazon, Microsoft, Facebook, Google, Apple Inc., Johnson & Johnson, Smartling, Genesis, Citco, AIG, SAP, Intel, Twitter, Redhat etc."],
                     ["Job Positions","Business Operations Analyst, Program Manager, Operations Manager, Product Manager, Product Strategist, Digital Optimization lead, Business Analyst, Senior advisor etc."],
                     ["Starting Salary Offered", "Rs.36 - 37 Lakhs INR/Year"],
                     ["Medium of Education", "English Language"],
                     ["Top Management University", "University college, Dublin and Trinity college, Dublin"]  ]
        },
          {
            type: 'list-bollet',
        ...
        },
        {
            ...
            data: '<p><strong style="color: red;"><u>Step 1</u>:</strong>   To <strong>study in Ireland</strong>, students should fit in the given eligibility criteria for education plus any student whose first language is not English need to prove his/her proficiency in English language by giving exams like IELTS or TOEFL. Students must score above 6.0 in IELTS.</p><p><strong style="color: red;"><u>Step 2</u>:</strong>   Entry and application requirements for Ireland’s management courses are different for each university in Ireland. Students also need to clear Graduate Management Admissions Test (GMAT) with a minimum acceptable score of 550 which is required by the top universities.</p><p><strong style="color: red;"><u>Step 3</u>:</strong>   For <strong>MBA admission</strong> in Ireland, students need to submit personal essay, SOP (Statement of Purpose) and an essay on goals in student’s life, at the time of admission along with the resume and other necessary documents.</p>'
        },
        {
            "type": "table-title",
        ...
        },
        {
            ...
            info: 'By reading books, students can consume a lot of research in a relatively short amount of time and they can also improve their skills:',
            data: ""
        },
        {
            type: 'list-bollet',
   ...
   { "type": "table",
    ...
    // meta: [{ name: "title", content: "MBA in Ireland | Top B-Schools, Fees, Eligibility, Course Duration" },{ name: "description", content: "Want to study MBA in Ireland at top business schools? Click here to know about top MBA schools in Ireland with their fees, duration of courses, and eligibility." },],link:[{ rel:"canonical", href:"https://www.selectyouruniversity.com/course/mba-in-ireland"},]
}
